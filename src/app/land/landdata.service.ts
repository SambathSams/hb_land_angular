...
const baseUrl3 = 'http://localhost:8080/landdigitdata/edit';
const baseUrl4 = 'http://localhost:8080/landdigitdata/delete';
const baseUrl5 = 'http://localhost:8080/api/ForgetPassword';
const baseUrl6 = 'http://localhost:8080/api/changepassword';
const baseUrl7 = 'http://localhost:8080/landdigitdata/report1';
const baseUrl8 = 'http://localhost:8080/getfile';
const baseUrl9 = 'http://localhost:8080/update';
const baseUrl10 = 'http://localhost:8080/merge';
...
export class LanddataService {
  ...
  verifyotp(username : any, otp : any) {
    return this.http.post<any>('http://localhost:8080/api/VerifyOtp', { username, otp }).pipe(
      map(otpData => {
